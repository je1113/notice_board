...
<body>
    ...
    <form action="./Member" name="regform" id="regform" method="post" onsubmit="return sendit()">
        ...
        <p>성별 <label>남자<input type="radio" name="gender" value="남자"></label> <label>여자<input type="radio" name="gender" value="여자" checked></label></p>
        ...
        <p>우편번호: <input type="text" name="zipcode" maxlength="5" id="sample6_postcode"> <button type="button" onclick="sample6_execDaumPostcode()" value="우편번호 찾기">검색</button></p>
        ...
        <!-- <input type="reset" value="다시작성"> 같은기능을 한다. -->
